...
if (isset($_GET['del'])) 
{
    ...
    $query1 = mysqli_query( $con, "delete from tandoor_deals where Name='$del'");
...
?>
    ...
    if (isset($_GET['Name'])) {
    $name = $_GET['Name'];
    $query1 = mysqli_query($con ,"select * from tandoor_deals where Name = '$myname'");
    while ($row1 = mysqli_fetch_array($query1)) 
    {
        ...
        echo "<br />";
        echo "</form>";
        echo "<b><a href='tandoor_delete.php?del={$row1['Name']}'><input class='btn btn-danger' type='button' name='submit' value='Delete'/></a></b>"; 
