...
if (isset($_GET['submit'])) 
{
    ...
    $query = mysqli_query($con , "update kfc_deals set Price='$myprice',Description='$mydescription' where Name = '$myname'");
}
...
if (isset($_GET['update'])) {
    $update = $_GET['update'];
    $query1 = mysqli_query($con ,"select * from kfc_deals where Name = '$update'");
