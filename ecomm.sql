...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 11, 2022 at 05:00 AM
...
INSERT INTO `bannedusers` (`id`, `userid`, `email`, `action`, `date`) VALUES
(10, 32, 'aye@gmail.com', 'banned', '2022-02-10'),
(11, 34, 'abc@gmail.com', 'banned', '2022-02-10');
...
INSERT INTO `cart` (`id`, `user_id`, `product_id`, `quantity`, `dayss`) VALUES
(28, 9, 1, 1, 1);
...
(1, 1275936919, 384891541, 'hello'),
(2, 384891541, 1275936919, 'hi');
...
--
-- Dumping data for table `rentdays`
--

INSERT INTO `rentdays` (`days`, `user_id`, `product_id`) VALUES
(2, 9, 9);
...
CREATE TABLE `report` (
  ...
  `against_id` varchar(200) NOT NULL,
...
INSERT INTO `report` (`id`, `from_id`, `against_id`, `request`) VALUES
(23, 'umaima@gmail.com', 'aka@gmail.com', 'bad product');
...
(13, 9, 'PAY-IIZ9XLKYARRC1BI1WBWSHU', '2022-02-09'),
(14, 9, 'PAY-3N326OUPZHIRQ0ADR2XI6W', '2022-02-09'),
(15, 9, 'PAY-UZPPCVQQNUYXRZLUXNYN3A', '2022-02-10'),
(16, 36, 'PAY-KSBIWAVQUJ8JCLYMCPCUPB', '2022-02-10');
...
INSERT INTO `users` (`CNIC`, `id`, `email`, `password`, `type`, `firstname`, `lastname`, `address`, `contact_info`, `photo`, `status`, `activate_code`, `reset_code`, `created_on`) VALUES
('1234567891011', 9, 'umaima@gmail.com', '$2y$10$Oongyx.Rv0Y/vbHGOxywl.qf18bXFiZOcEaI4ZpRRLzFNGKAhObSC', 0, 'Umaima', 'Hussain', 'Karachi', '09078601', 'pikach.jpg', 1, 'k8FBpynQfqsv', 'wzPGkX5IODlTYHg', '2021-05-09'),
('1234567891011', 23, 'ak@gmail.com', '$2y$10$5rnb24IY9l/b4g75mUIKYeU.u16BdR/DcB0Nu58E5IldjIbffO5OW', 2, 'Ahmed', 'Khan', '', '', '', 1, 'uL5A3l2JzVOv', '', '2022-02-10'),
('1234567891011', 25, 'p.aijaz@gmail.com', '$2y$10$UaFB0Urz3le.GDceQmmhuOkJBzQOeVdcGGKn3hnNU.EubKu68bp96', 0, 'Preh', 'Aijaz', '', '', '', 1, 'Gco9DbnUlHyY', '', '2022-01-02'),
('1234567891011', 26, 'ayesha@gmail.com', '$2y$10$vvke2xDpbw5F7C/4cT4FguTOMCNx8H6RhVHIYjIiwwgXL5Ncru4Jm', 2, 'Ayesha', 'Ahmed', '', '', '', 1, 'lnW9ozk6YtbS', '', '2022-01-02'),
('1234567891011', 33, 'aka@gmail.com', '$2y$10$5rnb24IY9l/b4g75mUIKYeU.u16BdR/DcB0Nu58E5IldjIbffO5OW', 2, 'Ahmed', 'Khan', '', '', '', 1, 'uL5A3l2JzVOv', '', '2022-02-10'),
('1234567891011', 35, 'abc@gmail.com', '$2y$10$px67QsD9/gmwwAr7miLVo.JmNLC2aBQGMQbd5iBYTGN1/bNEYzJXa', 0, 'abc', 'def', '', '', '', 1, 'Kpy1mxSOFBCI', '', '2022-02-10'),
('1dadada', 36, 'aq@gmail.com', '$2y$10$3SFvBhQVMVsiaGP9Yvc0rejdJp/riBDgwNUnmsjLHisQHyDb5vJ4S', 0, 'Aqeel', 'tahir', '', '', '', 1, 'FSPAz7G8plbO', '', '2022-02-10');

--
-- Triggers `users`
--
DELIMITER $$
CREATE TRIGGER `Banned_users` BEFORE DELETE ON `users` FOR EACH ROW INSERT INTO bannedusers values (null,OLD.id,OLD.email,'banned',NOW())
$$
DELIMITER ;
